...
export function render(theme: typeof Theme) {
  return {
    ...
    colors: {
      ...
      //"activityBar.inactiveForeground": "#f7f7f766",
      ...
      //"editorGutter.commentRangeForeground": `${theme["foreground-darker-1"].hex()}`,
      //"editorGutter.deletedBackground": "#94151b",
      //"editorGutter.foldingControlForeground": `${theme["foreground-darker-1"].hex()}`,
      ...
      //"editorMarkerNavigationInfo.background": `${theme["cyan-darker-1"].hex()}`,
      //"editorMarkerNavigationWarning.background": `${theme["orange-darker-1"].hex()}`,
      ...
      //"editorOverviewRuler.warningForeground": `${theme["orange-darker-1"].hex()}`,
      ...
      //"editorSuggestWidget.selectedBackground": `${theme["background-lighter-2"].hex()}`,
      ...
      //"extensionButton.prominentForeground": `${theme["foreground-accent"].hex()}`,
      //"extensionButton.prominentHoverBackground": `${theme["green-darker-3"].hex()}`,
      ...
      //"notebook.cellInsertionIndicator": `${theme["background-lighter-3"].hex()}`,
      ...
      //"notificationsWarningIcon.foreground": `${theme["orange-darker-1"].hex()}`,
      ...
      //"peekViewResult.selectionForeground": `${theme["foreground-accent"].hex()}`,
      ...
      //"settings.numberInputBackground": `${theme["background-lighter-2"].hex()}`,
      ...
      //"statusBarItem.prominentForeground": `${theme["foreground-accent"].hex()}`,
      ...
      //"symbolIcon.enumeratorMemberForeground": `${theme["cyan-darker-1"].hex()}`,
      ...
      //"tab.unfocusedActiveBorder": "#f9579380",
      //"tab.unfocusedActiveForeground": "#f7f7f780",
      //"tab.unfocusedActiveModifiedBorder": "#3399cc80",
      //"tab.unfocusedHoverBackground": "#4c4c4c80",
      //"tab.unfocusedHoverBorder": "#ceb5ff80",
      //"tab.unfocusedInactiveBackground": `${theme["background-darker-1"].hex()}`,
